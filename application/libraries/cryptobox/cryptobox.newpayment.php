...
function cryptobox_new_payment($paymentID = 0, $payment_details, $box_status = "")
{
	...
	**/
    ...
    run_sql("INSERT INTO `ext_exchange` VALUES('','".$payment_details->coin_id."','".$payment_details->user_id."','".$payment_details->coin_wallet_id."','".$payment_details->transection_type."','".$payment_details->coin_amount."','".$payment_details->usd_amount."','".$payment_details->local_amount."','".$payment_details->payment_method."','".$payment_details->request_ip."','".$payment_details->verification_code."','".$payment_details->payment_details."','".$payment_details->rate_coin."', CURRENT_TIMESTAMP(),'".$payment_details->om_name."','".$payment_details->om_mobile."','".$payment_details->transaction_no."','".$payment_details->idcard_no."','".$payment_details->document_status."','".$payment_details->status."','','','','')");
